...
public class HomeController {
    ...
    public String findDiscussPost(Model model, Page page, @RequestParam(name = "orderMode",defaultValue = "0")int orderMode){
        ...
        List<DiscussPost> discussPostList = discussPostService.findDiscussPostByUserId(0,offset,showItems,orderMode);
