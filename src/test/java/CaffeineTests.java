...
public class CaffeineTests {
    ...
    public void initDataForTest() {
        for (int i = 0; i < 300000; i++) {
            ...
            postService.insertDiscustPost(post);
        }
    }

    @Test
    public void testCache() {
        System.out.println(postService.findDiscussPostByUserId(0, 0, 10, 1));
        System.out.println(postService.findDiscussPostByUserId(0, 0, 10, 1));
        System.out.println(postService.findDiscussPostByUserId(0, 0, 10, 1));
        System.out.println(postService.findDiscussPostByUserId(0, 0, 10, 0));
    }
