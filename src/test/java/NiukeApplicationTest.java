...
public class NiukeApplicationTest {
    ...
    private static final Logger logger = LoggerFactory.getLogger(NiukeApplicationTest.class);
    ...
    public void testDiscussMapper(){
        List<DiscussPost> discussPosts = discussPostMapper.selectDiscussPostByUserId(101,1,10);
